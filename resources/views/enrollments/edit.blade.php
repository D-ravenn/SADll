        ...
        <div class="my-auto">
            ...
            <nav>
                <ol class="flex items-center whitespace-nowrap min-w-0">
                    ...
                    <li class="text-[12px]">
                        <a class="flex items-center text-textmuted" href="javascript:void(0);">Edit Enrollment</a>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="xl:col-span-8 col-span-12 xl:col-start-3">
            <div class="box custom-box">
                <div class="box-header">
                    <div class="box-title">Edit Enrollment Details</div>
                </div>
                <div class="box-body">
                    <form action="{{ route('enrollments.update', $enrollment->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="Enrollment_status" name="Enrollment_status" class="form-control @error('Enrollment_status') is-invalid @enderror">
                                ...
                                <option value="pending" {{ old('Enrollment_status', $enrollment->Enrollment_status) === 'pending' ? 'selected' : '' }}>Pending</option>
